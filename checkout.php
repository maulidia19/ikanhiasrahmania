                        ...
                        <form class="needs-validation" novalidate>
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="invalid-feedback"> Nama belakang yang valid wajib diisi. </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="invalid-feedback" style="width: 100%;"> 
                                        Nama pengguna Anda diperlukan. </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="address">Alamat *</label>
                                <input type="text" class="form-control" id="address" placeholder="" required>
                                <div class="invalid-feedback"> Silakan masukkan alamat pengiriman Anda. </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="save-info">Simpan informasi ini untuk lain kali</label>
                            </div>
                            <hr class="mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="cc-name">Nama Kartu</label>
                                    <input type="text" class="form-control" id="cc-name" placeholder="" required> <small class="text-muted">Nama lengkap seperti yang ditampilkan pada kartu</small>
                                    <div class="invalid-feedback"> Name on card is required </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="cc-number">Nomer Kartu</label>
                            ...
                            <div class="odr-box">
                                ...
                                <div class="rounded p-2 bg-light">
                                    <div class="media mb-2 border-bottom">
                                        <div class="media-body"> <a href="detail.php"> Ikan Mas Koki</a>
                                            <div class="small text-muted">Harga:10.000 <span class="mx-2">|</span> Jumlah: 1 <span class="mx-2">|</span> Subtotal: 10.000</div>
                                        </div>
                                    </div>
                                    <div class="media mb-2 border-bottom">
                                        <div class="media-body"> <a href="detail.php"> Ikan Cupang Bluering</a>
                                            <div class="small text-muted">Harga : 30.000<span class="mx-2">|</span> Jumlah: 1 <span class="mx-2">|</span> Subtotal: 30.000</div>
                                        </div>
                                    </div>
                                    <div class="media mb-2">
                                        <div class="media-body"> <a href="detail.php"> Ikan Lemon</a>
                                            <div class="small text-muted">Harga : 5.000 <span class="mx-2">|</span> Jumlah: 1 <span class="mx-2">|</span> Subtotal: 5.000</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
