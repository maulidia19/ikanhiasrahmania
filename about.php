...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="about.php">Tentang</a></li>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h2 class="noo-sh-title">Selamat Datang di <span>Ikan Hias Rahmania</span></h2>
                    <p>"Selamat Datang di Ikan Hias Rahmania, diwebsite ini anda bisa melihat dan membeli ikan hias yang bisa menjadi teman bermain saat bosan atau bisa juga untuk mempercantik suasana rumah"</p>
                    <p>Diwebsite ini kami menjual ikan hias dengan berbagai jenis dan warna yang cantik-cantkik.
                        </p>
                </div>
                <div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-thumbnail img-fluid" src="images/tentang-bc.jpg" alt="" />
                    </div>
                </div>
            </div>
            <div class="row my-5">
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>Keuntungan Jika Anda Mendaftar</h3>
                        <p>Anda dapat membeli ikan hias yang disediakan diwebsite kami. </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>Untuk Anda yang tidak Mendaftar</h3>
                        <p>Untuk pengguna yang tidak terdaftar hanya bisa melihat dan tidak bisa membeli ikan hias. </p>
                    </div>
                </div>
                </div>
            </div>
