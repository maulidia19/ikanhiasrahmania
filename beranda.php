                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p><a class="btn hvr-hover" href="shop.php">Belanja</a></p>
                        </div>
                    </div>
                </div>
            </li>
                ...
                <div class="col-lg-3 col-md-6 special-grid best-seller">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <div class="mask-icon">
                                <ul>
                                    <li><a href="shop-detail.php" data-toggle="tooltip" data-placement="right" title="Lihat Detail"><i class="fas fa-eye"></i></a></li>
                                    <li><a href="wishlist.php" data-toggle="tooltip" data-placement="right" title="Favorit"><i class="far fa-heart"></i></a></li>
                                </ul>
                                <a class="cart" href="cart.php">Keranjang</a>
                            </div>
                        </div>
                        <div class="why-text">
                            <h4>Ikan Mas Koki</h4>
